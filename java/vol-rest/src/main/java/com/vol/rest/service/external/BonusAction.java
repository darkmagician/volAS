...
public class BonusAction {
    ...
    @Produces("application/json")   
    public boolean transfer(@PathParam("tenantId")Integer tenant, @FormParam("fromUser")String fromUserName,@FormParam("bonusId")Long bonusId, @FormParam("toUser")String toUser){
    	return bonusMgmt.transfer(tenant, bonusId, fromUserName, toUser);
    }	 
}
